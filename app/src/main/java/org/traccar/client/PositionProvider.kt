...
abstract class PositionProvider(
    ...
    protected var deviceId = preferences.getString(MainActivity.KEY_DEVICE, "undefined")!!
    protected var interval = preferences.getString(MainActivity.KEY_INTERVAL, "600")!!.toLong() * 1000
    protected var distance: Double = preferences.getString(MainActivity.KEY_DISTANCE, "200")!!.toInt().toDouble()
    protected var angle: Double = preferences.getString(MainActivity.KEY_ANGLE, "20")!!.toInt().toDouble()
